...
> 由于 solo 不再支持 servlet 方式部署，此项目停止维护，建议使用 [solo-in-docker](https://github.com/liumapp/solo-in-docker?utm_source=hacpai.com), 参见 [Solo v3.6.7 发布，移除 Servlet 容器支持](https://hacpai.com/article/1573408539790)
